...
if s_block_start("MP3_FILE"):

    # ----------------------------------------------------------------------------
    # MP3 DATA, FRAME
    # ----------------------------------------------------------------------------

    if s_block_start("MP3_FRAME"):

        # http://mpgedit.org/mpgedit/mpeg_format/mpeghdr.htm

        s_bitfield(0xFFFB1064, length=4, fuzzable=True, fields=[
        ...
        ], name="MP3_FRAME_HEADER")

        if s_block_start("MPEG_DATA"):
            s_string("\x37" * 100)          # MPEG Audio Data
        s_block_end("MPEG_DATA")
    s_block_end("MP3_FRAME")
